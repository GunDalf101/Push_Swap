...
/*   Updated: 2023/02/05 16:53:43 by mbennani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_cdlist **stack_b, t_helper *container);
void		ra_rra_mover(t_cdlist **stack_a, \
t_cdlist **stack_b, t_helper *container);
void		rb_rrb_mover(t_cdlist **stack_a, \
t_cdlist **stack_b, t_helper *container);
void		world_vs_minsteps(t_cdlist **stack_a, \
t_cdlist **stack_b, t_helper *container, int comparer);
void		super_sort(t_cdlist **stack_b, t_cdlist **stack_a);
void		min_locker(t_cdlist **stack_a, \
t_cdlist **stack_b, t_helper *container);
